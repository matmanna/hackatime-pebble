...
i asked my clanker to make ts for my pebble time 2 so i can track my likelihood to suffer adverse health outcomes (including insanity, blood clots, etc.) and obviously this will help me touch grass more, _right?_
...
- current streak
- top 5 languages for the day
- top 3 projects for the day

**as well as the following options in the pebble app:**

- hackatime username
- max language count
- max project count

<img width="350" alt="screenshot of hackatime app options" src="https://github.com/user-attachments/assets/a4ddbc41-acd3-4152-bdd2-4989f701006d" />
